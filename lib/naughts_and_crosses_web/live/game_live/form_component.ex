defmodule NaughtsAndCrossesWeb.GameLive.FormComponent do
  use NaughtsAndCrossesWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:naught]} type="text" label="Naught" />
        <.input field={@form[:crosses]} type="text" label="Crosses" />
        <:actions>
